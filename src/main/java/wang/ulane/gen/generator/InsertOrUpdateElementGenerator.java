 ...
 * 
 */
public class InsertOrUpdateElementGenerator extends
        AbstractXmlElementGenerator {

    public InsertOrUpdateElementGenerator() {
        super();
    }
    ...
    public void addElements(XmlElement parentElement) {
        ...
        XmlElement orUpdateElement = new XmlElement("trim"); //$NON-NLS-1$
        orUpdateElement.addAttribute(new Attribute("suffixOverrides", ",")); //$NON-NLS-1$ //$NON-NLS-2$
        answer.addElement(orUpdateElement);
        ...
        for (IntrospectedColumn introspectedColumn : ListUtilities.removeIdentityAndGeneratedAlwaysColumns(introspectedTable
            ...
            if (introspectedColumn.isSequenceColumn()
                ...
                sb.append(MyBatis3FormattingUtilities
                		.getEscapedColumnName(introspectedColumn));
                sb.append("),");
                orUpdateElement.addElement(new TextElement(sb.toString()));
                continue;
            }
            ...
            sb.append(introspectedColumn.getJavaProperty());
            sb.append(" != null"); //$NON-NLS-1$
            XmlElement orUpdateNotNullElement = new XmlElement("if"); //$NON-NLS-1$
            orUpdateNotNullElement.addAttribute(new Attribute(
                    "test", sb.toString())); //$NON-NLS-1$
            ...
            sb.append(MyBatis3FormattingUtilities
            		.getEscapedColumnName(introspectedColumn));
            sb.append("),");
            orUpdateNotNullElement.addElement(new TextElement(sb.toString()));
            orUpdateElement.addElement(orUpdateNotNullElement);
        }
